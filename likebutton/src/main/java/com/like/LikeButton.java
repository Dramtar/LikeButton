...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    private ImageView dotsSecondStageView;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        dotsSecondStageView = (ImageView) findViewById(R.id.dots_second_stage);
        ...
        this.dotsView.getLayoutParams().height = (int)(iconSize * 1.4);
        this.dotsSecondStageView.getLayoutParams().width = (int)(iconSize * 1.4);

        dotsView.setImageDrawable(getDrawableFromResource(array, R.styleable.LikeButton_dots_drawable));
        dotsSecondStageView.setImageDrawable(getDrawableFromResource(array, R.styleable.LikeButton_second_stage_dots_drawable));
    ...
    public void onClick(View v) {
        ...
        if (isChecked) {
            ...
            ObjectAnimator dotsAnimatorY = ObjectAnimator.ofFloat(dotsView, ImageView.SCALE_Y, 0.5f, 1.3f);
            dotsAnimatorY.setDuration(450);
            dotsAnimatorY.setInterpolator(ACCELERATE_DECELERATE_INTERPOLATOR);

            ObjectAnimator dotsAnimatorX = ObjectAnimator.ofFloat(dotsView, ImageView.SCALE_X, 0.5f, 1.3f);
            dotsAnimatorX.setDuration(450);
            dotsAnimatorX.setInterpolator(ACCELERATE_DECELERATE_INTERPOLATOR);

            ObjectAnimator dotsAnimatorAlpha = ObjectAnimator.ofFloat(dotsView, ImageView.ALPHA, 0.25f, 1f, 0);
            dotsAnimatorAlpha.setDuration(350);
            dotsAnimatorAlpha.setInterpolator(ACCELERATE_DECELERATE_INTERPOLATOR);



            ObjectAnimator dotsSecondStageAnimatorY = ObjectAnimator.ofFloat(dotsSecondStageView, ImageView.SCALE_Y, 0.3f, 1.5f);
            dotsAnimatorY.setDuration(450);
            dotsAnimatorY.setInterpolator(ACCELERATE_DECELERATE_INTERPOLATOR);

            ObjectAnimator dotsSecondStageAnimatorX = ObjectAnimator.ofFloat(dotsSecondStageView, ImageView.SCALE_X, 0.3f, 1.5f);
            dotsAnimatorX.setDuration(450);
            dotsAnimatorX.setInterpolator(ACCELERATE_DECELERATE_INTERPOLATOR);

            ObjectAnimator dotsSecondStageAnimatorAlpha = ObjectAnimator.ofFloat(dotsSecondStageView, ImageView.ALPHA, 0.25f, 1f, 0);
            dotsAnimatorAlpha.setDuration(550);
            dotsAnimatorAlpha.setInterpolator(ACCELERATE_DECELERATE_INTERPOLATOR);
            animatorSet.playTogether(
                    ...
                    dotsAnimatorX,
                    dotsAnimatorAlpha,
                    dotsSecondStageAnimatorY,
                    dotsSecondStageAnimatorX,
                    dotsSecondStageAnimatorAlpha
            );
     ...
     * @param resId
     */
    public void setDotsDrawableRes(@DrawableRes int resId) {
        dotsView.setImageDrawable(ContextCompat.getDrawable(getContext(), resId));
    }
     ...
     * @param likeDrawable
     */
    public void setDotsDrawable(Drawable likeDrawable) {
        dotsView.setImageDrawable(likeDrawable);
    }
     ...
     * @param resId
     */
    public void setSecondStageDrawableRes(@DrawableRes int resId) {
        dotsSecondStageView.setImageDrawable(ContextCompat.getDrawable(getContext(), resId));
    }
     ...
     * @param likeDrawable
     */
    public void setSecondStageDrawable(Drawable likeDrawable) {
        dotsSecondStageView.setImageDrawable(likeDrawable);
    }
